...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/apis.md
...
- name: APIMetrics List API Calls
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/calls-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/calls-get-openapi.md
- name: APIMetrics Create new API Call
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/calls-post-openapi.md
- name: APIMetrics List API Calls by Authentication
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsauthauth-id-get-openapi.md
- name: APIMetrics Delete an API Call
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsid-delete-openapi.md
- name: APIMetrics Get an existing API Call
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsid-get-openapi.md
- name: APIMetrics Update an existing API Call
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsid-put-openapi.md
- name: APIMetrics Trigger an API Call to run
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsidrun-post-openapi.md
- name: APIMetrics List Stats from before a date for an API Call
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsidstatsbefore-get-openapi.md
- name: APIMetrics List Stats since a date for an API Call
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/callsidstatssince-get-openapi.md
- name: APIMetrics
  x-api-slug: apimetrics
  description: API performance monitoring, Cloud Service, SLA monitoring and analysis
    that gives you answers, not excuses. Find out how today.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/apimetrics/openapi.md
x-common:
- type: x-base-url
