...
- name: Twilio Get Calls
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/twilio/accounts-accountsid-calls-format-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/calls/master/_listings/twilio/accounts-accountsid-calls-format-get-postman.md
x-common:
- type: x-net-library
